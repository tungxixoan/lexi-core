...
Part6Set _set() => Part6Set(
      id: 'p1',
      passages: const [
        Part6Passage(
          passageText: 'We (1)___ to inform you of the change.',
          questions: [
            Part6Question(
...
void main() {
  ...
  testWidgets('reuse navigates to the part6 session on a match', (tester) async {
    await tester.pumpWidget(_buildHome(
      settings: _settings(),
      savedService: _FakeSavedExercisesService(
        random: (
