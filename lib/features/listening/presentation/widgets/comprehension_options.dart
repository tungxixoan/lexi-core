...
class ComprehensionOptions extends ConsumerStatefulWidget {
  const ComprehensionOptions({super.key});

  @override
  ConsumerState<ComprehensionOptions> createState() =>
      _ComprehensionOptionsState();
}

class _ComprehensionOptionsState extends ConsumerState<ComprehensionOptions> {
  ...
  Future<void> _reuse(BuildContext context, WidgetRef ref) async {
    ...
    final passageJson = <String, dynamic>{
      ...
      'level': result.generationFilters['level'] ?? result.passageJson['level'],
      'context':
